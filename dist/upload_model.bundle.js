(function () {
  ...
  __vue_render__._withStripped = true;
    ...
    /* scoped */
    const __vue_scope_id__ = "data-v-46f106ce";
    /* module identifier */
    ...
    return _c(
      ...
      [
        ...
        _c(
          "vue-dropzone",
          {
            ref: "ImageVueDropzone",
            attrs: { options: _vm.dropOptions, useCustomSlot: true }
          },
          [
            _c("div", { staticClass: "dropzone-custom-content" }, [
              _c("h3", { staticClass: "dropzone-custom-title" }, [
                _vm._v("Drag and drop to upload model!")
              ]),
              _vm._v(" "),
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-6c4a8a62_0", { source: "\nhtml\n{\n\toverflow: hidden;\n\tfont-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n}\nheader fieldset\n{\n\tdisplay: inline-block;\n\tmargin: 0 .6em;\n\tborder: 0;\n\tpadding: 0;\n}\n.initializing\n{\n\tposition: fixed;\n\ttop: 0;\n\tleft: 0;\n\tbottom: 0;\n\tright: 0;\n\tfont-size: 10vh;\n\tpadding: 30vh 2em 0;\n\twhite-space: normal;\n\tbackground-color: #ccca;\n\tcolor: #444c;\n}\n.note-box\n{\n\ttransition: outline-color .6s ease-out;\n\toutline: 4px transparent solid;\n}\n.note-box.activated\n{\n\toutline-color: #0f6;\n\ttransition: outline-color .01s;\n}\nbutton.icon\n{\n\tbackground: transparent;\n\tborder: 0;\n\tcursor: pointer;\n}\nbutton.icon:hover\n{\n\ttransform: scale(1.1);\n}\n", map: undefined, media: undefined })
  ,inject("data-v-6c4a8a62_1", { source: "\n*[data-v-6c4a8a62] {\r\n  box-sizing: border-box;\n}\n.dropzone[data-v-6c4a8a62] {\r\n  min-height: 25rem;\n}\n.vue-dropzone[data-v-6c4a8a62] {\r\n  border-radius: 0.75rem;\r\n  margin-top: 2rem;\n}\n.vue-dropzone > .dz-preview[data-v-6c4a8a62] {\r\n  margin: 1rem .25rem;\n}\n.vue-dropzone > .dz-preview .dz-image[data-v-6c4a8a62] {\r\n  border-radius: 0.75rem;\n}\n.dropzone .dz-preview .dz-details[data-v-6c4a8a62] {\r\n  border-radius: 0.75rem;\n}\n.dropzone .dz-preview[data-v-6c4a8a62] {\r\n  margin: 0.5rem;\n}\n.dropzone-custom-content[data-v-6c4a8a62] {\r\n  text-align: center;\n}\n.dropzone-custom-title[data-v-6c4a8a62] {\r\n  margin-top: 0;\r\n  color: #00b782;\n}\n.subtitle[data-v-6c4a8a62] {\r\n  color: #314b5f;\n}\r\n", map: {"version":3,"sources":["/Users/baris/Documents/PycharmProjects/forked-stylegan-web/app/upload_model.vue"],"names":[],"mappings":";AAoDA;EACA,sBAAA;AACA;AAEA;EACA,iBAAA;AACA;AAEA;EACA,sBAAA;EACA,gBAAA;AACA;AAEA;EACA,mBAAA;AACA;AAEA;EACA,sBAAA;AAEA;AAEA;EACA,sBAAA;AAEA;AAEA;EACA,cAAA;AACA;AAEA;EACA,kBAAA;AACA;AAEA;EACA,aAAA;EACA,cAAA;AACA;AAEA;EACA,cAAA;AACA","file":"upload_model.vue","sourcesContent":["<template>\r\n  <div class=\"text-xs-center\">\r\n  <Navigator />\r\n    <vue-dropzone :options=\"dropOptions\" :useCustomSlot=true ref=\"ImageVueDropzone\">\r\n      <div class=\"dropzone-custom-content\">\r\n        <h3 class=\"dropzone-custom-title\">Drag and drop to upload model!</h3>\r\n        <div class=\"subtitle\">...or click to select a file from your computer</div>\r\n      </div>\r\n    </vue-dropzone>\r\n  </div>\r\n</template>\r\n\r\n<script>\r\nimport vueDropzone from 'vue2-dropzone';\r\nimport Navigator from \"./navigator.vue\";\r\n\r\nexport default {\r\n  name: \"projector\",\r\n\r\n\r\n  components: {\r\n    vueDropzone,\r\n    Navigator,\r\n  },\r\n\r\n\r\n  data() {\r\n    return {\r\n      dropOptions: {\r\n        url: '/upload_model',\r\n        thumbnailWidth: 200, // px\r\n        thumbnailHeight: 200,\r\n        chunking: false,\r\n        addRemoveLinks: true,\r\n        maxFilesize: 500,\r\n        timeout: 60000*5,\r\n      },\r\n    };\r\n  },\r\n\r\n  computed: {},\r\n\r\n  created() {\r\n    window.$main = this;\r\n    this.originTitle = document.title;\r\n  },\r\n};\r\n</script>\r\n\r\n<style src=\"./common.css\"></style>\r\n\r\n<style scoped>\r\n* {\r\n  box-sizing: border-box;\r\n}\r\n\r\n.dropzone {\r\n  min-height: 25rem;\r\n}\r\n\r\n.vue-dropzone {\r\n  border-radius: 0.75rem;\r\n  margin-top: 2rem;\r\n}\r\n\r\n.vue-dropzone > .dz-preview {\r\n  margin: 1rem .25rem;\r\n}\r\n\r\n.vue-dropzone > .dz-preview .dz-image {\r\n  border-radius: 0.75rem;\r\n\r\n}\r\n\r\n.dropzone .dz-preview .dz-details {\r\n  border-radius: 0.75rem;\r\n\r\n}\r\n\r\n.dropzone .dz-preview {\r\n  margin: 0.5rem;\r\n}\r\n\r\n.dropzone-custom-content {\r\n  text-align: center;\r\n}\r\n\r\n.dropzone-custom-title {\r\n  margin-top: 0;\r\n  color: #00b782;\r\n}\r\n\r\n.subtitle {\r\n  color: #314b5f;\r\n}\r\n</style>\r\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$1 = "data-v-6c4a8a62";
    /* module identifier */
